...
message = "On a enlevé l'âge de l'étudiant, sa valeur était: "
tempo = etudiant.pop('age')
print(f"{message}{tempo}")
...
message_exo6 = len(etudiant)
print(f"Nous avons maintenant {message_exo6} paires clés valeurs.")
